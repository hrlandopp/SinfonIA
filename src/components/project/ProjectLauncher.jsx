...
const ProjectCard = ({ project, onSelect }) => {
  ...
  return (
    <div className="group flex flex-col bg-black/40 backdrop-blur-md border border-white/10 rounded-xl transition-all duration-500 hover:border-emerald-500/50 hover:shadow-[0_0_30px_rgba(16,185,129,0.15)] hover:-translate-y-1 hover:bg-black/60 overflow-hidden">
      ...
      <div className="flex-1 p-5 -mt-8 relative z-10 flex flex-col">
        ...
        <div className="mt-6 mt-auto">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-500/20 text-emerald-400 border border-emerald-500/50 font-semibold text-sm rounded-lg transition-all duration-300 hover:bg-emerald-500 hover:text-zinc-950 hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] active:scale-[0.98]"
          >
...
const ProjectLauncher = () => {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-gradient-to-br from-zinc-950 via-zinc-900 to-emerald-950/20 text-zinc-100 font-sans relative">
      
      {/* Sidebar */}
      <div className="w-1/4 max-w-sm border-r border-white/10 bg-black/60 backdrop-blur-xl flex flex-col flex-shrink-0 z-20 shadow-[4px_0_24px_rgba(0,0,0,0.5)]">
      ...
      <div className="flex-1 overflow-y-auto p-10 lg:p-14 relative z-10">
        <div className={`max-w-6xl mx-auto flex flex-col gap-10 transition-opacity duration-500 ${activeTab === 'settings' ? 'opacity-30 pointer-events-none' : 'opacity-100'}`}>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-black/40 backdrop-blur-md p-8 rounded-2xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
            <div>
